...
void Fl_Color_Chooser_set_mode(Fl_Color_Chooser *self, int newMode) {
    LOCK(self->mode(newMode));
}
...
void Fl_Grid_set_layout(
    Fl_Grid *self, int rows, int cols, int margin, int gap
) {
